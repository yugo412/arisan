                        ...
                        <div class="app-utilities col-auto">
                                    ...
                                    <div class="dropdown-menu-content">
                                        <div class="item p-3">
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image" src="/images/profiles/profile-1.png"
                                                        alt="">
                                                </div>
                                                <!--//col-->
                                                <div class="col">
                                        ...
                                        <div class="item p-3">
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image" src="/images/profiles/profile-2.png"
                                                        alt="">
                                                </div>
                                                <!--//col-->
                                                <div class="col">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    role="button" aria-expanded="false"><img src="/images/user.png"
                                        alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="/images/app-logo.svg"
                            alt="logo"><span class="logo-text">{{ config('app.name') }}</span></a>
                    ...
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                            ...
                            <a class="nav-link {{ !Route::is('dashboard') ?: 'active' }}" href="{{ route('dashboard') }}">
                                ...
                                <span class="nav-link-text">@lang('Overview')</span>
                            </a>
                            <!--//nav-link-->
                        </li>
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                                ...
                                <span class="nav-link-text">@lang('Projects')</span>
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="notifications.html">@lang('Notifications')</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="account.html">@lang('Account')</a>
                                    </li>
                                    <li class="submenu-item"><a class="submenu-link" href="settings.html">@lang('Settings')</a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="help.html">
                                ...
                                <span class="nav-link-text">@lang('Help')</span>
                            </a>
                            <!--//nav-link-->
                        </li>
                        <!--//nav-item-->
